    ...
    <div class="l-navbar " id="nav-bar"> 
      <nav class="nav ">
        ...
        <aside class="col-lg-3" >
          ...
          <!-- lista de sidebar -->
          <div class="nav_list">
            <a href="<?php echo $url; ?>/admin/template/dashboard.php" class="nav_link">
              <i class="bx bx-home nav_icon"></i>
              <span class="nav_name">Administrador</span>
            </a>
            <a href="<?php echo $url; ?>/admin/seccion/publicar.php" class="nav_link">
              <i class="bx bx-list-plus nav_icon"></i>
              <span class="nav_name">Publicar</span>
            </a>
            <a href="<?php echo $url; ?>/admin/seccion/perfil.php" class="nav_link" >
              <i class="bx bxs-user nav_icon"></i>
              <span class="nav_name">Perfil</span>
            </a>
            <a href="<?php echo $url; ?>/admin/calendar/calendar.php" class="nav_link" >
