    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10">
            ...
            <div class="card shadow p-3 mb-3 bg-body rounded">
                <h1 class="fw-normal mb-3 pb-3 text-center" style="letter-spacing: 1px;">Publica tu salon</h1>
                <!-- start form -->
                <form action="publicarLogic.php" method="POST" enctype="multipart/form-data" id="multi-step-form">
                    <!-- step 1: name and description -->
                    <div class="step" id="step1">
                        <h5 class="fw-normal mb-3 pb-3 text-center">Descripcion del salon</h5>
                        ...
                        <div class="step" id="step2"  style="display: none;">
                            <h5 class="fw-normal mb-3 pb-3 text-center">Sube las mejores fotos de tu salon</h5>
                            <div class="form-group">
                                <label for="img1" class="form-label">Imagen 1:</label>
                                <input type="file" name="img1" class="form-control" id="img1" required>
                                <div id="emailHelp" class="form-text">Es necesario subir minimo una imagen del salon</div>
                            </div>
                            <br>
                            <div class="form-group">
                        ...
                        <div class="step" id="step3"  style="display: none;">
                            ...
                            <div id="emailHelp" class="form-text">El apartado se penso por motivos de seguridad, pero en esta version no esta habilitado la subida de PDF por cuestion de espacio</div>
                            <div class="form-group">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="form-label"for="proteccionCivil">Licencia de Proteccion Civil:</label>
