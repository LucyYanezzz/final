     ...
     <nav class="navbar navbar-light fixed-top gradient-custom">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo $url; ?>">
                <img src="../img/1 LogoNegro.svg" alt="Ibenteu Logo" width="30" height="24">
                Ibenteu
            </a>
        </div>
    </nav>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            ...
                            <form action="singUp.php" method="post" enctype="multipart/form-data">
                                <!-- titulo form -->
                                <h2 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Create Your Account</h2>
                                <!-- input name and icon -->
                                <div class="d-flex flex-row aling-items-center mb-4">
                                    <i class="bi bi-person-fill fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <label class="form-label"for="profilePhoto">Name:</label>
                                ...
                                <div class="d-flex flex-row aling-items-center mb-4">
                                    <i class="bi bi-person-fill fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <label class="form-label"for="profilePhoto">Lastname:</label>
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    <label class="form-label"for="profilePhoto">Phone:</label>
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    <label class="form-label"for="profilePhoto">Profile Image:</label>
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    ...
                                    <div id="emailHelp" class="form-text">It's required to upload your INE in PDF format for security reasons.</div>
                                </div>
                                </div>
                                <!-- input password -->
                                <div class="d-flex flex-row aling-items-center mb-4">
                                ...
                                <label class="form-label"for="profilePhoto">Password:</label>
                                    ...
                                    <input spellcheck="false" type="password" name="password" class="form-control" placeholder="Password" id="password" required>
                                ...
                                <div class="d-flex flex-row aling-items-center mb-4">
                                    <i class="bi bi-lock-fill fa-lg me-3 fa-fw"></i>
                                <div class="form-outline flex-fill mb-0">
                                    <label class="form-label"for="profilePhoto">Repeat password:</label>
                                    <div class="input-group">
                                    <input type="password" name="repeat_password" class="form-control" placeholder="Repeat password" id="password" required>
                                        <button type="button" name="eye" onclick="verPassword()" class="btn btn-outline-secondary">
                                            <i id="eye-icon" class="bi bi-eye"></i>
                                        </button>
                                    </div>
                                ...
                                <!-- submit -->
                                <div class="pt-1 mb-4">
                                    <input type="submit" name="owner" value="Submit" class="btn btn-dark btn-lg btn-block">
                                </div>
                            </form> 
                        </div>
                    </div>
...
<div class="container-fluid fixed-bottom  footer">
  ...
  <footer class="text-lg-start text-black mt-auto">
    <section class="d-flex flex-wrap p-3 b section-media">
      ...
      <div>
        <a href="https://www.facebook.com/profile.php?id=100095378201520" class="icon-social me-4" id="facebook">
          <i class="bx bxl-facebook-circle"></i>
        </a>
        <a href="https://www.instagram.com/ibenteu_cu/" class="icon-social me-4" id="instagram">
...
<div id="loader" class="loader-container">
    <img src="../img/loadinfDEF.gif" alt="Loading..." class="loader">
</div>
<!-- end loader -->
</html>
