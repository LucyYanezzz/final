...
if (isset($_GET['id'])) {
    $salonId = $_GET['id'];
            ...
            if (mysqli_stmt_prepare($stmtOwner, $queryOwner)) {
                ...
                echo "Error preparing owner's query";
            }
...
?>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-4">
                    <img src="<?php echo 'admin/seccion/'.$imagen['img1']; ?>" class="img-fluid" alt="Image 1">
                </div>
                <div class="col-md-4">
                    <img src="<?php echo 'admin/seccion/'.$imagen['img2']; ?>" class="img-fluid" alt="Image 2">
                </div>
                <div class="col-md-4">
                    <img src="<?php echo 'admin/seccion/'.$imagen['img3']; ?>" class="img-fluid" alt="Image 3">
                </div>
            </div>
            <?php } ?>
            <div class="card-body">
                ...
                <?php if (!empty($ownerDetalles['ine'])) { ?>
                    <p class="text-success"><i class="bi bi-person-check-fill"></i> Verified User</p>
                <?php } ?>
                <hr>
                <h5 class="card-title text-dark">
                ...
                <?php if (!empty($calendar)) { ?>
                    <hr>
                    <h5 class="card-title text-dark">
                        <i class="bi bi-calendar-fill"></i> Occupied Dates
                    </h5>
                    <ul class="list-group">
                ...
                <?php } ?>
                <hr>
                <p class="text-success"><i class="bi bi-folder-check"></i> Verified Venue</p>
                <hr>
            </div>
        </div>
    </div>
