...
<body>
    ...
    // agrego todos los eventos existentes al calendario
    $events   = ("SELECT * FROM calendar");
    $resEvents = mysqli_query($cnx, $events);
    ?>
    <br><br><br>
    <!-- genero el calendario con el metodo de la api -->
    <div class="container ">
        <br>
    ...
    <!-- inicia la logica del calendario -->
    <script>
            // traemos los id y generamos el modal
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // especificaciones de nuestro calendario
                headerToolbar: {
                    left: 'prev, next, today',
                    center: 'title',
                    right: 'dayGridMonth, listWeek'
                },
                // funcion para hacer drag and drop 
                ...
                // funcion para sacar los eventos
                    events: {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        ...
                        // utilizamos alertas de sweetalert
                        Swal.fire({
                            title: 'Error',
                            text: data.message,
                            icon: 'error'
