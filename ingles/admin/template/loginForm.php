                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form action="login.php" method="post">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    ...
                                    <input type="email" placeholder="Enter your mail:" name="mail" class="form-control" required>
                                </div>
                                </div>
                                <!-- password -->
                                <div class="d-flex flex-row aling-items-center mb-4">
                                ...
                                <!-- boton submit login -->
                                <div class="pt-1 mb-4">
                                    <input type="submit" value="Log In" name="login" class="btn btn-dark btn-lg btn-blobk">
                                </div>
